import {BookshelfCubeSchema, BookshelfSchema, BookshelfType, CubeType, MapConfig, SideModuleSchema, SideModuleType} from '../Schema';
...
function createMapConfig () {
    ...
    let bookshelfs:BookshelfCubeSchema[] = [];
    /**
     * 
     * @param cols 
     * @param rows 
     * @param cubeSchema 
     */
    function generateCubeSet (total:number, rowNum:number,spaceX, spaceY, cubeSchema:BookshelfCubeSchema){
        let result = [];
    ...
    mapConfig.elements.push(...generateCubeSet(4, 4,  20 , 20, bookshelfAtSix))
    // mapConfig.elements.push(...generateCubeSet(4, 4,  28 , 20, bookshelfAtDesk))
...
export {LayersMap, bookshelfConfig, mapConfig}
